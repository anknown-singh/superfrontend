          ...
          <Col lg={6}>
            <Table>
              <thead>
                <tr>
                  <th>Switch Name</th>
                  <th className="text-right">Switch Example</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className="text-inverse">Diabled, Unchecked</td>
                  <td className="text-right">
                    <Toggle defaultChecked={false} disabled={true} />
                  </td>
                </tr>
                <tr>
                  <td className="text-inverse">Disabled, Checked</td>
                  <td className="text-right">
                    <Toggle defaultChecked={true} disabled={true} />
                  </td>
                </tr>
                <tr>
                  <td className="text-inverse">Custom className</td>
                  <td className="text-right">
                    <Toggle
                ...
                <tr>
                  <td className="text-inverse">Custom Icons</td>
                  <td className="text-right">
                    <Toggle
              ...
              <tbody>
                ...
                <tr>
                  <td className="d-flex align-items-middle">
                    ...
                    />
                    <label htmlFor="cheese-status" className="ml-2 mb-0 text-inverse">
                      Adjacent label tag
                    </label>
                  </td>
                </tr>
                <tr>
                  <td className="d-flex align-items-middle">
                    ...
                    />
                    <span id="biscuit-label" className="ml-2 text-inverse">
