  ...
  <Row>
    <Col md={6}>
      <div>
        ...
        <p>
          Discover goods you&apos;ll love from brands that inspire. The easiest way to open your own
          online store. Discover amazing stuff or open your own store for free!
        </p>
        <small>Below is a sample page for your cart, Created using pages design UI Elementes</small>
      </div>
    </Col>
    <Col md={6}>
      <Table>
        ...
        <Row>
          ...
          <Col sm={12}>
            <FormGroup>
              ...
              <InputGroup>
                <InputGroupAddon addonType="prepend" tag={UncontrolledDropdown}>
  ...
  <Row>
    <Col md={6}>
      <div>
        ...
        <small>
          Invoice are issued on the date of despatch. Payment terms: Pre-orders: within 10 days of
          invoice date with 4% discount, from the 11th to the 30th day net. Re-orders: non-reduced
...
export class WizardExample extends React.Component {
  ...
  _isComplete = (stepId) => sequence.indexOf(stepId) < sequence.indexOf(this.state.currentStep);
}
