...
import { Container, Row, Col, Card, CardTitle, CardBody, Progress } from '../../../components';
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                ...
                <code>
                  {' '}
                  &lt;Progress value={'{'}25{'}'}&gt;&lt;i className="fa
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            className="mt-5"
            subTitle={
              <React.Fragment>Below are often used UI cases in applications.</React.Fragment>
            }
          />
        </Col>
      </Row>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">A combined example that is often used in UI/UX.</p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <Progress value="95" color="danger" className="mt-0">
                95%
              </Progress>
            </CardBody>
          </Card>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <div className="d-flex justify-content-between">
                ...
                <Progress value="55" color="success" className="mt-1 w-100">
                  55%
                </Progress>
