...
import { Container, Row, Col, Card, CardTitle, CardBody, Badge } from '../../../components';
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={<React.Fragment>Basic button layout options.</React.Fragment>}
          />
        </Col>
      </Row>
      {/* END Header 1 */}
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-default</code> to the base{' '}
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-secondary</code> to the base{' '}
                <code>.label</code> class.
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-success</code> to the base{' '}
                <code>.label</code> class.
              </p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-danger</code> to the base{' '}
                <code>.label</code> class.
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-warning</code> to the base{' '}
                <code>.label</code> class.
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-info</code> to the base{' '}
                <code>.label</code> class.
              </p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-light</code> to the base{' '}
                <code>.label</code> class.
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">
                Default label styling. To use, add <code>.label-dark</code> to the base{' '}
                <code>.label</code> class.
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#4.07</span>
              </CardTitle>
              <p className="card-text">
                Default label styling. To use, add <code>.label-light</code> to the base{' '}
                <code>.label</code> class.
