...
const Dropdowns = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Dropdowns" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={<React.Fragment>Dropdown component states</React.Fragment>}
          />
        </Col>
      </Row>
      {/* END Header 1 */}
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>Default dropdown menu styling.</p>
              <UncontrolledButtonDropdown>
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            className="mt-5"
            subTitle={<React.Fragment>Dropdown header with options</React.Fragment>}
          />
        </Col>
      </Row>
      {/* END Header 2 */}
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>Display left/right positioned icons.</p>
              <UncontrolledButtonDropdown>
                <DropdownToggle caret color="secondary" outline>
                  Dropdown
                </DropdownToggle>
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            className="mt-5"
            subTitle={<React.Fragment>Icons, checkboxes, radios, switches etc.</React.Fragment>}
          />
        </Col>
      </Row>
      {/* END Header 3 */}
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>Dropdown icons in left position.</p>
              <UncontrolledButtonDropdown>
                <DropdownToggle caret color="secondary" outline>
                  Dropdown
                </DropdownToggle>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>Dropdown icons in right position.</p>
              <UncontrolledButtonDropdown>
                <DropdownToggle caret color="secondary" outline>
                  Dropdown
                </DropdownToggle>
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <UncontrolledButtonDropdown>
                ...
                <DropdownMenu persist>
                  <DropdownItem header>Select Style</DropdownItem>
                  <DropdownItem>
                    <CustomInput
                      type="radio"
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <UncontrolledButtonDropdown>
                ...
                <DropdownMenu persist>
                  <DropdownItem header>Select Javascript</DropdownItem>
                  <DropdownItem>
                    <CustomInput
                      type="checkbox"
                  ...
                  <DropdownItem>
                    <CustomInput type="checkbox" id="DropdownLeftCheckbox2" label="Angular" />
                  </DropdownItem>
                  <DropdownItem divider />
                  <DropdownItem>
                    <CustomInput type="checkbox" id="DropdownLeftCheckbox3" label="Other..." />
                  </DropdownItem>
                </DropdownMenu>
              </UncontrolledButtonDropdown>
            </CardBody>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>with Buttons, Inputs and Checkbox.</p>
              <UncontrolledButtonDropdown>
                <DropdownToggle caret color="secondary" outline>
                  Dropdown
                </DropdownToggle>
          ...
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                ...
                <code>&lt;Dropdown direction="right" /&gt;</code> and{' '}
