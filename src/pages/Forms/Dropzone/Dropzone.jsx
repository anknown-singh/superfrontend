...
import { Container, Divider, Badge, Button, ButtonGroup } from '../../../components';
import { FilesGrid, FilesList } from './components';
...
export class Dropzone extends React.Component {
  ...
  render() {
    ...
    return (
      <Container>
        <HeaderMain title="Dropzone" className="mb-5 mt-4" />
        {/*    DropZone    */}
        <div className="mb-4">
          <p className="mb-3">
          ...
          >
            {({ getRootProps, getInputProps }) => (
              <div {...getRootProps()} className={dropzoneClass}>
                ...
                <p>
                  Drag a file here or <span className="text-primary">browse</span> for a file to
                  upload.
                </p>
                <p className="small">
                  JPG, GIF, PNG, MOV, and AVI. Please choose files under 2GB for upload. File sizes
                  are 400x300px.
                </p>
                <input {...getInputProps()} />
              </div>
