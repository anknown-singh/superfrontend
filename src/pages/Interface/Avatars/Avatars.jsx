      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                There are versions available default, that is avatar: large: avatar{' '}
                <code>avatar-lg</code> & small: avatar <code>avatar-sm</code>.
              </React.Fragment>
            }
          />
        </Col>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <Avatar.Image size="lg" src={randomAvatar()} className="mr-2" />
              <Avatar.Image size="lg" src={randomAvatar()} className="mr-2" />
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">Large size avatar example</p>
              <Avatar.Image size="sm" src={randomAvatar()} className="mr-2" />
              <Avatar.Image size="sm" src={randomAvatar()} className="mr-2" />
              <Avatar.Image size="sm" src={randomAvatar()} className="mr-2" />
            </CardBody>
          </Card>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">Large size avatar example</p>
              <Avatar.Font size="lg" bgColor="primary" className="mr-2">
                VN
              </Avatar.Font>
              <Avatar.Font size="md" bgColor="info" className="mr-2">
                FS
              </Avatar.Font>
              <Avatar.Font size="sm" bgColor="secondary" className="mr-2">
                +4
              </Avatar.Font>
            </CardBody>
          </Card>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">Large size avatar example</p>
              <Avatar.Font size="lg" bgColor="200" className="mr-2">
                <i className="fa fa-user" />
              </Avatar.Font>
              <Avatar.Font size="md" bgColor="200" className="mr-2">
                <i className="fa fa-plus" />
              </Avatar.Font>
              <Avatar.Font size="sm" bgColor="200" className="mr-2">
              ...
              <Avatar.Image
                ...
                addOns={[
                  <AvatarAddOn.Icon
                    ...
                    key="avatar-icon-white-bg"
                  />,
                  <AvatarAddOn.Icon className="fa fa-circle" color="danger" key="avatar-icon-bg" />,
                  <AvatarAddOn.Icon
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <Avatar.Font bgColor="light" fgColor="secondary" className="mr-1">
                LI
              </Avatar.Font>
              <Avatar.Font bgColor="white" fgColor="secondary" className="mr-1">
                WH
              </Avatar.Font>
            </CardBody>
          </Card>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">Large size avatar example</p>
              <Avatar.Font bgColor="100" fgColor="secondary" className="mr-1">
                100
              </Avatar.Font>
              <Avatar.Font bgColor="200" fgColor="secondary" className="mr-1">
                200
              </Avatar.Font>
              <Avatar.Font bgColor="300" fgColor="secondary" className="mr-1">
                300
              </Avatar.Font>
              <Avatar.Font bgColor="400" fgColor="secondary" className="mr-1">
                400
              </Avatar.Font>
              <Avatar.Font bgColor="500" fgColor="dark" className="mr-1">
                500
              </Avatar.Font>
              <Avatar.Font bgColor="600" fgColor="white" className="mr-1">
                600
              </Avatar.Font>
              <Avatar.Font bgColor="700" fgColor="white" className="mr-1">
                700
              </Avatar.Font>
              <Avatar.Font bgColor="800" fgColor="white" className="mr-1">
                800
              </Avatar.Font>
              <Avatar.Font bgColor="900" fgColor="white" className="mr-1">
                900
              </Avatar.Font>
            </CardBody>
          </Card>
        ...
        <Col lg={12}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="card-text">Large size avatar example</p>
              <Avatar.Font bgColor="facebook" fgColor="white" className="mr-1">
                <i className="fa fa-facebook" />
              </Avatar.Font>
              <Avatar.Font bgColor="twitter" fgColor="white" className="mr-1">
                <i className="fa fa-twitter" />
              </Avatar.Font>
              <Avatar.Font bgColor="lastfm" fgColor="white" className="mr-1">
                <i className="fa fa-lastfm" />
              </Avatar.Font>
              <Avatar.Font bgColor="pinterest" fgColor="white" className="mr-1">
                <i className="fa fa-pinterest" />
              </Avatar.Font>
              <Avatar.Font bgColor="linkedin" fgColor="white" className="mr-1">
                <i className="fa fa-linkedin" />
              </Avatar.Font>
              <Avatar.Font bgColor="medium" fgColor="white" className="mr-1">
                <i className="fa fa-medium" />
              </Avatar.Font>
              <Avatar.Font bgColor="skype" fgColor="white" className="mr-1">
                <i className="fa fa-skype" />
              </Avatar.Font>
              <Avatar.Font bgColor="foursquare" fgColor="white" className="mr-1">
                <i className="fa fa-foursquare" />
              </Avatar.Font>
              <Avatar.Font bgColor="android" fgColor="white" className="mr-1">
                <i className="fa fa-android" />
              </Avatar.Font>
              <Avatar.Font bgColor="spotify" fgColor="white" className="mr-1">
                <i className="fa fa-spotify" />
              </Avatar.Font>
              <Avatar.Font bgColor="paypal" fgColor="white" className="mr-1">
                <i className="fa fa-paypal" />
              </Avatar.Font>
              <Avatar.Font bgColor="dribbble" fgColor="white" className="mr-1">
                <i className="fa fa-dribbble" />
              </Avatar.Font>
              <Avatar.Font bgColor="youtube" fgColor="white" className="mr-1">
                <i className="fa fa-youtube" />
              </Avatar.Font>
              <Avatar.Font bgColor="windows" fgColor="white" className="mr-1">
                <i className="fa fa-windows" />
              </Avatar.Font>
              <Avatar.Font bgColor="amazon" fgColor="white" className="mr-1">
