          ...
          <CardBody className="bb-0">
            <span className="d-flex">
              ...
              <span className="ml-auto justify-content-start">
                ...
                <a href="javascript:;" id="TemperaturesTooltipAdd" className="text-decoration-none">
          ...
          <CardBody className="bb-0">
            <span className="d-flex">
              ...
              <span className="ml-auto justify-content-start">
                ...
                <a href="javascript:;" id="UsageTooltipAdd" className="text-decoration-none">
                  <i className="fa fa-fw fa-plus"></i>
                </a>
              </span>
              ...
              <CardBody className="bb-0">
                <span className="d-flex">
                  ...
                  <span className="ml-auto justify-content-start">
                    ...
                    <a href="javascript:;" id="CoolingTooltipAdd" className="text-decoration-none">
                      <i className="fa fa-fw fa-plus"></i>
                    </a>
                  </span>
                ...
                <Row>
                  <Col lg={6}>
                    <dl className="row mb-0">
                      ...
                      <dd className="col-sm-7 text-right text-inverse">Windows 10 x64</dd>
                  ...
                  <Col lg={6}>
                    <dl className="row mb-0">
                      ...
                      <dd className="col-sm-7 text-right text-inverse">John Malkovich</dd>
                      <dt className="col-sm-5">Network</dt>
                      <dd className="col-sm-7 text-right text-inverse">Wireless Network</dd>
                    </dl>
                  </Col>
                </Row>
