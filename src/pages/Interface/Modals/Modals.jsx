    ...
    <Row>
      <Col lg={12}>
        <HeaderDemo
          ...
          subTitle={
            <React.Fragment>
              Use modal plugin to add dialogs to your site for lightboxes, user notifications, or
          ...
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault101">
              ...
              <ModalFooter>
                ...
                <UncontrolledModal.Close color="primary">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          </CardBody>
    ...
    <Row>
      <Col lg={12}>
        <HeaderDemo
          ...
          className="mt-5"
          subTitle={
            <React.Fragment>There are three sizes of modals in the application.</React.Fragment>
          }
        />
      </Col>
    </Row>
    ...
    <Row>
      <Col lg={12}>
        <HeaderDemo
          ...
          subTitle={
            <React.Fragment>
              You can apply colors to make them easier to see for users. All colors work from the
              section
        ...
        <Card className="mb-3 text-center">
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault301" className="modal-outline-primary">
              ...
              <ModalBody>{faker.lorem.paragraph()}</ModalBody>
              <ModalFooter>
                <UncontrolledModal.Close color="link">Close</UncontrolledModal.Close>
                <UncontrolledModal.Close color="primary">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          ...
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault302" className="modal-outline-danger">
              ...
              <ModalFooter>
                ...
                <UncontrolledModal.Close color="danger">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          </CardBody>
          ...
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault303" className="modal-outline-info">
              ...
              <ModalFooter>
                ...
                <UncontrolledModal.Close color="info">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          </CardBody>
          ...
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault304" className="modal-outline-warning">
              ...
              <ModalFooter>
                ...
                <UncontrolledModal.Close color="warning">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          </CardBody>
          ...
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault305" className="modal-outline-success">
              ...
              <ModalFooter>
                ...
                <UncontrolledModal.Close color="success">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          </CardBody>
          ...
          <CardBody>
            ...
            <UncontrolledModal target="modalDefault306" className="modal-outline-dark">
              ...
              <ModalFooter>
                ...
                <UncontrolledModal.Close color="dark">Save</UncontrolledModal.Close>
              </ModalFooter>
            </UncontrolledModal>
            {/* END Example Modal */}
          </CardBody>
          ...
          <CardBody className="table-primary">
            ...
            <UncontrolledModal target="modalDefault401" className="modal-primary">
              ...
              <ModalBody className="text-center px-5">
                ...
                <h6>Welcome</h6>
                <p className="modal-text">We're glad to see you again and wish you a nice day.</p>
          ...
          <CardBody className="table-danger">
            ...
            <UncontrolledModal target="modalDefault402" className="modal-danger">
              ...
              <ModalBody className="table-danger text-center px-5">
                ...
                <h6>Danger</h6>
                <p className="modal-text">Change a few things up and try submitting.</p>
          ...
          <CardBody className="table-warning">
            ...
            <UncontrolledModal target="modalDefault404" className="modal-warning">
              ...
              <ModalBody className="table-warning text-center px-5">
                ...
                <h6>Warning</h6>
                <p className="modal-text">Better check yourself, you're not looking too good.</p>
