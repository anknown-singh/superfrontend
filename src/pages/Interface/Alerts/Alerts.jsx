...
const Alerts = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Alerts" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
      ...
      <Row>
        ...
        <Col lg={6}>
          ...
          <div className="mb-4">
            ...
            <Alert color="primary">
              <h6 className="mb-1 alert-heading">Morning!</h6>
          ...
          <div className="mb-4">
            ...
            <Alert color="danger">
              <h6 className="mb-1 alert-heading">Oh Snap!</h6>
          ...
          <div className="mb-4">
            ...
            <Alert color="info">
              <h6 className="mb-1 alert-heading">Heads Up!</h6>
        ...
        <Col lg={6}>
          ...
          <div className="mb-4">
            ...
            <Alert color="success">
              <h6 className="mb-1 alert-heading">Well Done!</h6>
          ...
          <div className="mb-4">
            ...
            <Alert color="dark">
              <h6 className="mb-1 alert-heading">Attention</h6>
        ...
        <Col lg={6}>
          ...
          <div className="mb-4">
            ...
            <Alert color="primary">
              ...
              <span>
                <strong className="alert-heading">Welcome!</strong> We're glad to see you again and
                wish you a nice day.
              </span>
            </Alert>
          </div>
          ...
          <div className="mb-4">
            ...
            <Alert color="danger">
              ...
              <span>
                <strong className="alert-heading">Danger!</strong> Change a few things up and try
                submitting again.
              </span>
            </Alert>
          </div>
          ...
          <div className="mb-4">
            ...
            <Alert color="info">
              ...
              <span>
                <strong className="alert-heading">Information!</strong> This alert needs your
                attention, but it's not important.
              </span>
            </Alert>
          </div>
          {/* END Example */}
        ...
        <Col lg={6}>
          ...
          <div className="mb-4">
            ...
            <Alert color="warning">
              ...
              <span>
                <strong className="alert-heading">Warning!</strong> Better check yourself, you're
          ...
          <div className="mb-4">
            ...
            <Alert color="success">
              ...
              <span>
                <strong className="alert-heading">Success!</strong> You successfully read this
          ...
          <div className="mb-4">
            ...
            <Alert color="dark">
              ...
              <span>
                <strong className="alert-heading">Attention!</strong> This alert needs your
                attention, but it's not important.
              </span>
            </Alert>
          </div>
          ...
          <div className="mb-4">
            ...
            <Alert color="primary">
              <Media>
                ...
                <Media body>
                  <h6 className="mb-1 alert-heading">Welcome!</h6>
          ...
          <div className="mb-4">
            ...
            <Alert color="danger">
              <Media>
                ...
                <Media body>
                  <h6 className="mb-1 alert-heading">Danger!</h6>
          ...
          <div className="mb-4">
            ...
            <Alert color="info">
              <Media>
                ...
                <Media body>
                  <h6 className="mb-1 alert-heading">Information!</h6>
          ...
          <div className="mb-4">
            ...
            <Alert color="success">
              <Media>
                ...
                <Media body>
                  <h6 className="mb-1 alert-heading">Success!</h6>
                  You successfully read this important alert message.
                </Media>
              </Media>
            </Alert>
          ...
          <div className="mb-4">
            ...
            <Alert color="primary">
              <Media>
                ...
                <Media body>
                  <h6 className="alert-heading mb-1">Welcome!</h6>
                  We're glad to see you again and wish you a nice day.
                  <div className="mt-2">
          ...
          <div className="mb-4">
            ...
            <Alert color="danger">
              <Media>
                ...
                <Media body>
                  <h6 className="alert-heading mb-1">Danger!</h6>
                  Change a few things up and try submitting.
                  <div className="mt-2">
          ...
          <div className="mb-4">
            ...
            <Alert color="warning">
              <Media>
                ...
                <Media body>
                  <h6 className="alert-heading mb-1">Warning!</h6>
                  Better check yourself, you're not looking too good.
                  <div className="mt-2">
