...
import { TrTableSummary } from '../../components/Stock/TrTableSummary';

import { TrTableStock } from '../../components/Stock/TrTableStock';

import { TrTableFavStock } from '../../components/Stock/TrTableFavStock';
...
const Stock = () => (
  <Container>
    <Row className="mb-2">
      <Col lg={12}>
        <HeaderMain title="Stock" className="mb-4 mb-lg-4" />
      </Col>
    </Row>
    <Row>
      <Col lg={12}>
        <Table responsive size="sm" className="mb-4 text-nowrap">
          <thead>
            <tr>
              <td className="bt-0">
                <h4 className="mb-1">Your 5</h4>
                Favourites Stocks
              </td>
              <td className="bt-0">
                <h4 className="mb-1">AAPL</h4>
