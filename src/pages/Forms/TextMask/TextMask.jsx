...
import { Row, Card, CardBody, Container, Col, FormGroup, Label, Input } from '../../../components';
...
export const TextMask = () => (
  <Container>
    ...
    <p className="mb-3">
      Text Mask is an input mask library. It can create input masks for <code>phone</code>,
      <code>date</code>, <code>currency</code>, <code>zip code</code>, <code>percentage</code>,{' '}
      <code>email</code>, and literally anything!
    </p>
    <Card>
      <CardBody>
        <Row>
          ...
          <Col lg={4}>
            <FormGroup>
              ...
              <Input mask={emailMask} placeholder="john@smith.com" tag={MaskedInput} id="email" />
            </FormGroup>
          </Col>
          <Col lg={4}>
            <FormGroup>
