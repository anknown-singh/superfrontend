...
const SettingsEdit = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Settings Edit" className="mb-5 mt-4" />
      {/* START Content */}
      <Row>
        <Col lg={12}>
          <ProfileHeader />
            ...
            <CardBody>
              ...
              <Form>
                ...
                <FormGroup className="mb-5">
                  ...
                  <p className="mb-2">Control the emails that publications send to you.</p>
                ...
                <FormGroup className="mb-5">
                  ...
                  <p className="mb-2">Notify me via email when...</p>
                  <CustomInput
                    type="radio"
                    id="someoneComments"
                  ...
                  <CustomInput
                    ...
                    id="someoneMentions"
                    name="ActivityNotifications"
                    label="Someone Mentions"
                  />
                  <CustomInput
                    type="radio"
                    id="anyoneFollowsMe"
                    name="ActivityNotifications"
                    label="Anyone Follows Me"
                  />
                </FormGroup>
                {/* END Input */}
              </Form>
