...
const TooltipsPopovers = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Tooltips & Popovers" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
          ...
          <Card className="mb-3">
            <CardBody>
              <CardText>
                ...
                <a href="#" id="UncontrolledTooltip1">
                  you probably
                </a>{' '}
                ...
                apparel{' '}
                <a href="#" id="UncontrolledTooltip2">
                  have a
                </a>{' '}
                ...
                <a href="#" id="UncontrolledTooltip3">
                  whatever keytar
                </a>
                , scenester farm-to-table banksy Austin{' '}
                <a href="#" id="UncontrolledTooltip4">
                  twitter handle
                </a>{' '}
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                Four options are available: <code>top</code>, <code>right</code>,{' '}
                <code>bottom</code>, and <code>left</code> aligned.
              </React.Fragment>
            }
          />
        </Col>
          ...
          <Card className="mb-3">
            <CardBody className="text-center">
              ...
              <UncontrolledPopover placement="top" target="UncontrolledPopoverTop">
                ...
                <PopoverBody>{faker.lorem.paragraph()}</PopoverBody>
              </UncontrolledPopover>
            </CardBody>
          </Card>
        </Col>
