          ...
          <Card>
            <CardBody>
              <div className="d-flex mb-4">
                <CardTitle tag="h6">Profile Edit</CardTitle>
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    ...
                    <FormText color="muted">
                      JPG, GIF, PNG, MOV and AVI. Please choose a files under 2GB to upload. File
                      sizes are 400 x 300px.
                    </FormText>
                  </Col>
                </FormGroup>
                {/* END File Select */}
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    <CustomInput type="select" name="customSelect" id="jobType">
                ...
                {/* END Select */}
                <div className="small mt-5 mb-3">Availability</div>
                {/* START Radios */}
                <FormGroup row>
                ...
                <div className="small mt-4 mb-3">Fill Profile</div>
                {/* END Radios */}
                {/* START Textarea */}
                <FormGroup row>
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    <Input type="text" name="" id="addLabels" placeholder="Add Here..." />
                  </Col>
                </FormGroup>
                {/* END Input */}
              </Form>
