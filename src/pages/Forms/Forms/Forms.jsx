            ...
            <CardBody>
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <CustomInput type="select" name="customSelect" id="customSelect">
                      <option defaultValue="">Open this Select Menu</option>
                      <option>One</option>
                      <option>Two</option>
                      <option>Three</option>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Input type="textarea" name="text" id="textArea" placeholder="Enter text..." />
                  </Col>
                </FormGroup>
                {/* END Input */}
              </Form>
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Input type="select" name="select" id="multipleSelect" multiple>
                      <option>One</option>
                      <option>Two</option>
                      <option>Three</option>
                      <option>Four</option>
              ...
              <Form>
                  ...
                  <Col sm={9}>
                    <Row>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="inputHelper-1" placeholder="" />
                        <FormText color="muted">Left Text Helper</FormText>
                      </Col>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="inputHelper-2" placeholder="" />
                        <FormText color="muted text-center">Center Text Helper</FormText>
                      </Col>
                      <Col sm={12} lg={4}>
                        <Input type="text" name="" id="inputHelper-3" placeholder="" />
                        <FormText color="muted text-right">Right Text Helper</FormText>
                      </Col>
                    </Row>
                  </Col>
                </FormGroup>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Row>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="inputIcon-1" placeholder="" />
                        <FormText color="muted">
                      ...
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="inputIcon-2" placeholder="" />
                      ...
                      <Col sm={12} lg={4}>
                        <Input type="text" name="" id="inputIcon-3" placeholder="" />
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Row>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="inputBadge-1" placeholder="" />
                        <FormText>
                          <Badge color="primary">Left Badge Helper</Badge>
                        </FormText>
                      </Col>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="inputBadge-2" placeholder="" />
                        <FormText className="text-center">
                          <Badge color="success">Center Badge Helper</Badge>
                        </FormText>
                      </Col>
                      <Col sm={12} lg={4}>
                        <Input type="text" name="" id="inputBadge-3" placeholder="" />
                ...
                <FormGroup row>
                  ...
                  <Col sm={9} className="d-flex align-items-center">
                    <FormGroup check inline>
                      <Input type="text" name="" id="inputInline" placeholder="" />
                    </FormGroup>
                    <FormGroup check inline>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9} className="d-flex align-items-center">
                    <FormGroup check inline>
                      <Input type="text" name="" id="inputInlineBadge" placeholder="" />
                    </FormGroup>
                    <FormGroup check inline>
                      <Badge color="danger">Must be 8-20 characters long.</Badge>
                    </FormGroup>
                  </Col>
                </FormGroup>
                {/* END Input Inline */}
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Input type="text" name="" id="inputWithoutValidation" placeholder="" />
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Row>
                      ...
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="select" name="select" id="largeSize-2" bsSize="lg">
                      ...
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <CustomInput type="select" name="customSelect" id="largeSize-3" bsSize="lg">
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Row>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="text" name="" id="defaultSize-1" placeholder="Default Input" />
                      </Col>
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                      ...
                      <Col>
                        <CustomInput type="select" name="customSelect" id="defaultSize-3">
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <Row>
                      ...
                      <Col sm={12} lg={4} className="mb-3 mb-md-0">
                        <Input type="select" name="select" id="smSize-2" bsSize="sm">
                      ...
                      <Col sm={12} lg={4}>
                        <CustomInput type="select" name="customSelect" id="smSize-3" bsSize="sm">
                  ...
                  <div className="mb-5">
                    ...
                    <Form>
                      <FormGroup>
                        <FormGroup check>
                          <Label check>
                            <Input type="checkbox" defaultChecked /> Checked Checkbox
                          </Label>
                        </FormGroup>
                        <FormGroup check>
                          <Label check>
                  ...
                  <div className="mb-5">
                    ...
                    <Form>
                      <FormGroup>
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" name="radioStacked" defaultChecked /> Checked Radio
                          </Label>
                        </FormGroup>
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" name="radioStacked" /> Unchecked Radio
                          </Label>
                        </FormGroup>
                        <FormGroup check disabled>
                          <Label check>
                            <Input type="radio" name="radioStacked" disabled /> Disabled Radio
                          </Label>
                        </FormGroup>
                      </FormGroup>
                    </Form>
                  ...
                  <div>
                    ...
                    <Form>
                      <FormGroup>
                        <FormGroup check inline>
                          <Label check>
                            <Input type="radio" name="radioInline" defaultChecked /> Checked
                          </Label>
                        </FormGroup>
                        <FormGroup check inline>
                          <Label check>
                        ...
                        <FormGroup check disabled inline>
                          <Label check>
                            <Input type="radio" name="radioInline" disabled /> Disabled
                          </Label>
                        </FormGroup>
                      </FormGroup>
                    </Form>
