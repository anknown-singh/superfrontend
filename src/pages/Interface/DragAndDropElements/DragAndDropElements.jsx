...
import { MultipleVerticalLists, DraggableTable, HorizontalLists } from './components';
    ...
    return (
      <Container>
        <div className="d-flex">
          <div>
            <HeaderMain title="Drag &amp; Drop Elements" className="mb-5 mt-4" />
          </div>
          <Button
        ...
        <div className="mb-5">
          <HeaderDemo no="2" title="Table" subTitle="Allows reordering of the table rows" />
