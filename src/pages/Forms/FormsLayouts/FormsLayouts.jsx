...
const FormsLayouts = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Forms Layouts" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                Create horizontal forms with the grid by adding the .row class to form groups and
                using the .col-*-* classes to specify the width of your labels and controls.
              </React.Fragment>
            }
          />
        </Col>
            ...
            <CardBody>
              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    <Input type="text" name="" id="input-1" placeholder="Enter Name..." />
                  </Col>
                </FormGroup>
                {/* END Input */}
                {/* START Input */}
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    <CustomInput type="select" name="customSelect" id="country-selector-1">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <Form>
                ...
                {/* START Select */}
                <FormGroup>
                  <CustomInput type="select" name="customSelect" id="country-selector">
                    <option value="">Select Country...</option>
                    <option>United States of America (US)</option>
                    <option>United Kingdom (UK)</option>
                    <option>Australia</option>
            ...
            <CardBody>
              ...
              <Form>
                ...
                <FormGroup>
                  ...
                  <Input type="text" name="" id="input-2" placeholder="Enter Name..." />
                </FormGroup>
                {/* END Input */}
                {/* START Input */}
                <FormGroup>
                ...
                <FormGroup>
                  ...
                  <CustomInput type="select" name="customSelect" id="country-selector-2">
                    <option value="">Select Country...</option>
                    <option>United States of America (US)</option>
                    <option>United Kingdom (UK)</option>
                    <option>Australia</option>
