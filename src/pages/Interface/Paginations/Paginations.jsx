      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                Documentation and examples for showing pagination to indicate a series of related
          ...
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                ...
                to provide proper screen reader support with <code>aria</code> attributes and the{' '}
