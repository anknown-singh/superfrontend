...
const cardText = ({ cardNo }) => (
  <CardText>
    <span className="mr-2 text-muted">#{cardNo}</span> Lorem ipsum dolor sit amet, consectetur
    adipiscing elit. Nulla nisl elit, porta a sapien eget, fringilla sagittis ex.
  </CardText>
);
...
const Buttons = () => (
  <React.Fragment>
    <Container>
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo no={1} title="Buttons Colors" subTitle="Available panel styles and colors" />
        </Col>
      </Row>
      {/* END Header 1 */}
      {/* START Section 1 */}
        ...
        <Col lg={4}>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                ...
                <code>&lt;Button color="secondary"&gt;Secondary&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="success"&gt;Success&lt;/Button&gt; </code>
              </p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="warning"&gt;Warning&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="danger"&gt;Danger&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="info"&gt;Info&lt;/Button&gt; </code>
              </p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="light"&gt;Light&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="dark"&gt;Dark&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Custom color button, example:
                <code>&lt;Button color="purple"&gt;Purple&lt;/Button&gt; </code>
              </p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="facebook"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="twitter"&gt;...&lt;/Button&gt; </code>
              </p>
              <Button color="facebook">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="lastfm"&gt;...&lt;/Button&gt; </code>
              </p>
              <Button color="lastfm">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="pinterest"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="linkedin"&gt;...&lt;/Button&gt; </code>
              </p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="medium"&gt;...&lt;/Button&gt; </code>
              </p>
              <Button color="medium">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="android"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="spotify"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="foursquare"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="skype"&gt;...&lt;/Button&gt; </code>
              </p>
              <Button color="skype">
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Youtube
                <span className="small ml-1 text-muted">#2.11</span>
              </CardTitle>
              <p>
                Default button, example:
                <code>&lt;Button color="youtube"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="windows"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Default button, example:
                <code>&lt;Button color="amazon"&gt;...&lt;/Button&gt; </code>
              </p>
              <Button color="amazon">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                ...
                <code>&lt;Button outline color="secondary"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                ...
                <code>
                  &lt;Button outline color="secondary"&gt;&lt;i className="fa fa-home mr-2"
                  /&gt;&lt;/Button&gt;{' '}
                </code>
              </p>
              <Button outline color="secondary">
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <UncontrolledButtonDropdown>
                ...
                <DropdownMenu>
                  <DropdownItem header>Your Options</DropdownItem>
                  <DropdownItem>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.08</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.09</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Link
                <span className="small ml-1 text-muted">#3.10</span>
              </CardTitle>
              <p>
                Button as Link
                <code>&lt;Button outline color="link"&gt;...&lt;/Button&gt; </code>
              </p>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.11</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.12</span>
              </CardTitle>
              <p>Colored button with dropdown</p>
              {/* START Button Dropdown */}
              <UncontrolledButtonDropdown>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.13</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.14</span>
              </CardTitle>
              <p>Button with a single icon only</p>
              <Button outline color="secondary">
                <i className="fa fa-fw fa-bars"></i>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.15</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.17</span>
              </CardTitle>
              <p>Works with all button types</p>
              <Button color="secondary">
                <i className="fa fa-fw fa-bars"></i>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.18</span>
              </CardTitle>
              <p>Icon button with dropdown</p>
              {/* START Button Dropdown */}
              <UncontrolledButtonDropdown>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.19</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#3.20</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#6.04</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#7.05</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#7.06</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#7.07</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#7.08</span>
              </CardTitle>
              <p>Segmented button dropdown</p>
              {/* START Button Group Dropdown */}
              <ButtonGroup>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#7.09</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Dropright
                <span className="small ml-1 text-muted">#7.10</span>
              </CardTitle>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Dropleft
                <span className="small ml-1 text-muted">#7.11</span>
              </CardTitle>
              <p>Basic button dropright example</p>
              {/* START Button Dropdown */}
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#7.12</span>
              </CardTitle>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Outline
                <span className="small ml-1 text-muted">#8.01</span>
              </CardTitle>
              <p>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Toolbar
                <span className="small ml-1 text-muted">#8.02</span>
              </CardTitle>
              <p>
                Example:
                <code>
                  &lt;ButtonToolbar&gt;&lt;ButtonGroup&gt;&lt;Button outline
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Checkboxes
                <span className="small ml-1 text-muted">#8.03</span>
              </CardTitle>
              <p>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Radios
                <span className="small ml-1 text-muted">#8.04</span>
              </CardTitle>
              <p>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#8.05</span>
              </CardTitle>
              <p>
        ...
        <Col lg={4}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Block
                <span className="small ml-1 text-muted">#8.06</span>
              </CardTitle>
              <p>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Button: Nesting
                <span className="small ml-1 text-muted">#8.07</span>
              </CardTitle>
              <p>Below example</p>
              <i>TO-DO...</i>
            </CardBody>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                ...
                <span className="small ml-1 text-muted">#8.08</span>
              </CardTitle>
              <p>Below example</p>
              <i>TO-DO...</i>
            </CardBody>
