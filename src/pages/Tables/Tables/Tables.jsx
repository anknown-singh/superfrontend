...
import { Container, Row, Col, Card, CardTitle, CardBody, Table } from '../../../components';
...
import { TrTableStriped } from './components/TrTableStriped';
import { TrTableHoverable } from './components/TrTableHoverable';
import { TrTableSmall } from './components/TrTableSmall';
import { TrTableBorderless } from './components/TrTableBorderless';
import { TrTableBordered } from './components/TrTableBordered';
import { TrTableHeads } from './components/TrTableHeads';
import { TrTableContextual } from './components/TrTableContextual';

const Tables = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Tables" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={
              <React.Fragment>
                All table styles are inherited in Bootstrap 4, meaning any nested tables will be
        ...
        <Col lg={12}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="mb-0">
                Using the most basic table markup, here’s how <code>.table-based</code> tables look
                in Bootstrap. All table styles are inherited in Bootstrap 4, meaning any nested
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="mb-0">
                ...
                responsive across all viewports by wrapping a <code>Table</code> with{' '}
            ...
            <Table className="mb-0" responsive>
              <thead>
                <tr>
                  ...
                  <th className="text-right bt-0">Action</th>
                </tr>
              </thead>
              <tbody>
                <TrTableResponsive />
            ...
            <Table className="mb-0" striped responsive>
              <thead>
                <tr>
                  ...
                  <th className="text-right bt-0">Last Month</th>
                </tr>
              </thead>
              <tbody>
                <TrTableStriped />
        ...
        <Col lg={12}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p className="mb-0">
                Add <code>size="sm"</code> to make tables more compact by cutting cell padding in
                half.
              </p>
            </CardBody>
            {/* START Table */}
            <Table className="mb-0" hover responsive>
              <thead>
                <tr>
                  ...
                  <th className="text-right bt-0">Payment</th>
                </tr>
              </thead>
              <tbody>
                <TrTableSmall />
            ...
            <Table className="mb-0" hover responsive>
              <thead className="thead-light">
                <tr>
                  ...
                  <th className="text-right bt-0">Role</th>
                </tr>
              </thead>
              <tbody>
                <TrTableHeads />
        ...
        <Col lg={12}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Table Contextual
                <span className="small ml-1 text-muted">#9.01</span>
              </CardTitle>
              <p className="mb-0">
            ...
            <Table className="mb-0" hover responsive>
              <thead>
                <tr>
                  ...
                  <th className="bt-0">Price</th>
                  <th className="bt-0">Status</th>
                  <th className="text-right bt-0">Country</th>
                </tr>
              </thead>
              <tbody>
                <TrTableContextual />
