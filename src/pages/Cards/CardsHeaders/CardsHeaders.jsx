...
const Cards = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Cards Headers" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo
            ...
            <UncontrolledTabs initialActiveTabId="users201a">
              <CardHeader>
                <Nav tabs className="card-header-tabs">
                  <NavItem>
                    <UncontrolledTabs.NavLink tabId="users201a">Users</UncontrolledTabs.NavLink>
                  </NavItem>
                  <NavItem>
            ...
            <UncontrolledTabs initialActiveTabId="users204a">
              <CardBody>
                <Nav pills className="mb-3">
                  <NavItem>
                    <UncontrolledTabs.NavLink tabId="users204a">Users</UncontrolledTabs.NavLink>
                  </NavItem>
                  <NavItem>
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex">
                ...
                <Pagination size="sm" aria-label="Page navigation example" className="ml-auto">
                  {' '}
                  <PaginationItem>
