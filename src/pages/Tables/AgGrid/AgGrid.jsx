...
import { Container, Card, CardFooter, CardHeader, Input, InputGroup } from '../../../components';
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <p className="pb-3">
          <strong>Over 2,500 Companies use ag-Grid.</strong> The &quot;ag&quot; part of ag-Grid
          stands for &quot;agnostic&quot;. The internal ag-Grid engine is implemented in TypeScript
          with zero dependencies. ag-Grid supports Angular through a wrapper component. The wrapper
          lets you use ag-Grid in your application like any other Angular component – you pass
          configuration through property bindings and handle events through event bindings. You can
          even use Angular components to customize the grid UI and cell contents / behavior.
        </p>
        ...
        <Card>
          ...
          <div className="ag-theme-bootstrap" style={{ height: '600px' }}>
            ...
            >
              <AgGridColumn headerName="" width={70} checkboxSelection suppressMenu />
