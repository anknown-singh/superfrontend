          ...
          <Card>
            <CardBody>
              ...
              <p className="text-left">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta sapiente earum,
                necessitatibus commodi eius pariatur repudiandae cum sunt officiis ex!
              </p>
              <div className="mt-4 mb-2">
        ...
        <Col lg={8}>
          <UncontrolledTabs initialActiveTabId="overview">
            ...
            <Nav pills className="mb-4 flex-column flex-md-row mt-4 mt-lg-0">
              <NavItem>
                <UncontrolledTabs.NavLink tabId="overview">Overview</UncontrolledTabs.NavLink>
              </NavItem>
              <NavItem>
              ...
              <NavItem>
                <UncontrolledTabs.NavLink tabId="chat">Chat</UncontrolledTabs.NavLink>
              </NavItem>
              <NavItem>
              ...
              <TabPane tabId="chat">
                <Card>
                  <CardHeader className="d-flex bg-white bb-0">
                    <h6 className="align-self-center mb-0">Chat with Romaine Weber</h6>
              ...
              <TabPane tabId="messages">
                <Card>
                  <CardBody className="d-flex">
                    ...
                    <span className="ml-auto">Showing 1 to 10 of 57 entries</span>
                  </CardBody>
                  {/* START Table */}
                  ...
                  <CardFooter className="d-flex">
                    ...
                    <span className="ml-auto align-self-center">Showing 1 to 10 of 57 entries</span>
                  </CardFooter>
                </Card>
              </TabPane>
            </UncontrolledTabs.TabContent>
