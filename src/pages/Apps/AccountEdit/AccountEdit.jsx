    ...
    <Container>
      ...
      <Row>
        ...
        <Col lg={9}>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">Change Username</CardTitle>
              <p>
                Changing the username is not recommended. In this connection, I can appear{' '}
                <a href="#">many problems</a>.
              </p>
          ...
          <Card className="mb-3 b-danger">
            ...
            <CardFooter className="small">
              ...
              <strong>Free Account</strong>? We won’t charge your PayPal account anymore.
            </CardFooter>
          </Card>
        </Col>
      </Row>
