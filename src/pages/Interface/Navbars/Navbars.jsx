  ...
  <React.Fragment>
    <Container>
      ...
      <p className="mt-4">
        ...
        navbar. Includes support for branding, navigation, and more, including support for our
        collapse plugin.
      </p>
      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo no={1} title="Navbars Light">
            Theming the navbar has never been easier thanks to Theme Providers. Wrap the{' '}
            <code>Navbar</code> with a <code>NavbarThemeProvider</code> component and set{' '}
            <code>style=&quot;light&quot;</code> and{' '}
