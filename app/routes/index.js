...
export const RoutedContent = () => {
  return (
    <Switch>
      <Redirect from="/" to="/pages/test" exact />
      ...
      <Route component={TestComponent} path="/pages/test" />
      <Route component={SalesDash} path="/pages/sales" />

      <Route component={PurchaseDashboard} path="/pages/purchase" />
