...
const BillingEdit = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Billing Edit" className="mb-5 mt-4" />
      {/* START Content */}
      <Row>
        <Col lg={12}>
          <ProfileHeader />
          ...
          <Card className="mb-3">
            <CardBody>
              <div className="d-flex mb-4">
                <CardTitle tag="h6">Billing Edit</CardTitle>
              ...
              <Row className="mb-4">
                ...
                <Col sm={9}>
                  <div className="mb-2">
                    <span className="text-inverse">Premium</span> - You use <strong>37%</strong> of
                    the available space.
                  </div>
              ...
              <Row>
                ...
                <Col sm={9}>
                  <div className="mb-2">
                    ...
                    <span className="text-inverse">PayPal</span> - Account:{' '}
                    <samp>Tyshawn_Lakin56@gmail.com</samp>
                  </div>
                  <dl className="row">
