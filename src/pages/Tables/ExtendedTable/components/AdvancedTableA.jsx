...
import { Badge, Button, CustomInput, StarRating, ButtonGroup } from '../../../../components';
...
const generateRow = (index) => ({
  ...
  quality: randomArray([ProductQuality.Bad, ProductQuality.Good, ProductQuality.Unknown]),
