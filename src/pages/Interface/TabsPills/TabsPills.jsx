      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            no={1}
            title="Pills Designs"
            subTitle={<React.Fragment>Default, bordered, toolbar layouts</React.Fragment>}
          />
        </Col>
      </Row>
      {/* END Header 1 */}
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Basic pills example using <code>&lt;Nav pills&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Easily make pills equal widths of their parent with <code>.nav-justified</code>{' '}
                class.
              </p>
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Pills are also vertically stackable. Just add <code>vertical</code> to the{' '}
                <code>Nav</code>.
              </p>
              <Nav pills vertical>
                <NavItem>
            ...
            <CardBody>
              ...
              <Nav pills className="nav-justified">
                <NavItem>
                  <NavLink href="#" active>
                    Profile
                    <Badge color="secondary" pill className="align-self-center ml-2">
                      3
                    </Badge>
                  </NavLink>
                </NavItem>
          ...
          <Card className="mb-3">
            <CardBody>
              ...
              <Nav pills className="nav-justified">
                <NavItem>
                  <NavLink href="#" active>
                    <Badge color="secondary" pill className="align-self-center mr-2">
                      3
                    </Badge>
                    Profile
                  </NavLink>
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
                <code>&lt;NavLink&gt;</code> class.
              </p>
              <Nav tabs>
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              ...
              <p>
                Easily make tabs equal widths of their parent with <code>.nav-justified</code>{' '}
                class.
              </p>
        ...
        <Col lg={6}>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Right Icons
                <span className="small ml-1 text-muted">#5.04</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Only Icons
                <span className="small ml-1 text-muted">#5.05</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Big Icons
                <span className="small ml-1 text-muted">#5.06</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
        ...
        <Col lg={6}>
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Right Pills
                <span className="small ml-1 text-muted">#5.07</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Only Pills
                <span className="small ml-1 text-muted">#5.08</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
              ...
              <Nav tabs>
                <NavItem>
                  <NavLink href="#" active>
                    <Badge color="secondary" pill className="align-self-center">
                      3
                    </Badge>
                  </NavLink>
                </NavItem>
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Left Pills
                <span className="small ml-1 text-muted">#5.09</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Right Badges
                <span className="small ml-1 text-muted">#5.10</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Left Badges
                <span className="small ml-1 text-muted">#5.11</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
          ...
          <Card className="mb-3">
            <CardBody>
              <CardTitle tag="h6">
                Tabs: Only Badges
                <span className="small ml-1 text-muted">#5.12</span>
              </CardTitle>
              <p>
                Basic tabs example using <code>&lt;Nav tabs&gt;</code> class. Also requires base{' '}
                <code>&lt;NavItem&gt;</code> and
