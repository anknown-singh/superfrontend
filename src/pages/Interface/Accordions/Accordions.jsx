...
import { Accordion, Container, Row, Col, CardText } from '../../../components';
...
const Accordions = () => (
  <React.Fragment>
    <Container>
      <HeaderMain title="Accordions" className="mb-5 mt-4" />
      {/* START Header 1 */}
      <Row>
        <Col lg={12}>
          <HeaderDemo no={1} title="Accordions Default" subTitle="Basic button layout options" />
        </Col>
      </Row>
      {/* END Header 1 */}
      {/* START Section 1 */}
      <Row>
        ...
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2" initialOpen>
              <Accordion.Header className="h6">Accordion Card #1</Accordion.Header>
              <Accordion.Body>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2" initialOpen>
              <Accordion.Header>Accordion Card #1</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
        ...
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <p>
              Below is an example of default accordion based on <code>Card</code>, <code>h6</code>,{' '}
              <code>&lt;i className="fa fa-fw fa-plus" /&gt;</code>
              and <code>UncontrolledCollapse</code>.
            </p>
            <Accordion className="mb-2" initialOpen>
        ...
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2 b-primary" initialOpen>
              <Accordion.Header className="text-primary">Primary Card #1</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
            ...
            <Accordion className="mb-2">
              <Accordion.Header className="text-success">Success Card #2</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
            ...
            <Accordion className="mb-2">
              <Accordion.Header className="text-danger">Danger Card #3</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
          ...
          <div className="mb-5">
            ...
            <Accordion className="mb-2 bg-primary text-white" initialOpen>
              <Accordion.Header className="text-white">Primary Card #1</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
            ...
            <Accordion className="mb-2 bg-success text-white">
              <Accordion.Header className="text-white">Success Card #2</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
            ...
            <Accordion className="mb-2 bg-danger text-white">
              <Accordion.Header className="text-white">Danger Card #3</Accordion.Header>
              <Accordion.Body>
                <CardText>{faker.lorem.paragraph()}</CardText>
              </Accordion.Body>
            </Accordion>
