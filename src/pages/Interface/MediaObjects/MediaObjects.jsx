      ...
      <Row>
        <Col lg={12}>
          <HeaderDemo
            no={1}
            title="Media Options"
            subTitle={<React.Fragment>Media list and media object layouts</React.Fragment>}
          />
        </Col>
      </Row>
      {/* END Header 1 */}
              ...
              <Media>
                ...
                <Media body>
                  <span className="d-flex mb-1">
                    ...
                    <span className="small align-self-center ml-auto">Yesterday</span>
                  </span>
                  <p>{faker.lorem.sentence()}</p>
                </Media>
              </Media>
              <Media>
                ...
                <Media body>
                  <span className="d-flex mb-1">
                    ...
                    <span className="small align-self-center ml-auto">12:23 PM</span>
                  </span>
                  <p>{faker.lorem.sentence()}</p>
                </Media>
              </Media>
              ...
              <Media>
                ...
                <Media body>
                  <div className="mb-1">
                    ...
                    <span className="small">{faker.name.title()}</span>
                  </div>
                  <p>{faker.lorem.sentence()}</p>
                </Media>
              </Media>
