...
import { Container, Row, Col, Card, CardBody, CardDeck, Button } from '../../../components';
...
export const ReCharts = () => (
  <Container>
    ...
    <p>
      Recharts is a Redefined chart library built with React and D3. The main purpose of this
      library is to help you to write charts in React applications without any pain. Main principles
      of Recharts are:
    </p>
    <ul className="mb-5">
      <li>
      ...
      <li>
        <strong>Native</strong> SVG support, lightweight depending only on some D3 submodules
      </li>
      <li>
        <strong>Declarative</strong> components, components of charts are purely presentational
      </li>
    </ul>
