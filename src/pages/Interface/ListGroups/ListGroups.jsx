        ...
        <Col lg={6}>
          ...
          <div className="mb-5">
            ...
            <p>
              ...
              Example: <code>&lt;ListGroupItem&gt; ... &lt;/ListGroupItem&gt;</code>.
            </p>
            <ListGroup>
          ...
          <div className="mb-5">
            ...
            <p>
              Add <code>disabled</code> to a <code>ListGroupItem</code> to make it appear disabled.
            </p>
            <ListGroup>
          ...
          <div className="mb-5">
            ...
            <p>
              Add <code>active</code> to a <code>ListGroupItem</code> to make it appear active.
            </p>
            <ListGroup>
          ...
          <div className="mb-5">
            ...
            <p>
              From the color palette, add to <code>&lt;ListGroupItem&gt;</code> for example:{' '}
              <code>success</code>, <code>primary</code> etc.
            </p>
            <ListGroup>
          ...
          <div className="mb-5">
            ...
            <ListGroup>
              <ListGroupItem active>
                <ListGroupItemHeading className="h6">List group item heading</ListGroupItemHeading>
                <ListGroupItemText className="mb-0">{faker.lorem.sentence()}</ListGroupItemText>
              </ListGroupItem>
              <ListGroupItem>
                <ListGroupItemHeading className="h6">List group item heading</ListGroupItemHeading>
                <ListGroupItemText className="mb-0">{faker.lorem.sentence()}</ListGroupItemText>
              ...
              <ListGroupItem tag="button" action href="#">
                <Media>
                  <Media body>
                    ...
                    <p className="text-success mb-0">{faker.lorem.sentence()}</p>
                  </Media>
                  <Media right top>
                    <Avatar.Image
                      size="md"
