        ...
        <Row>
          <Col>
            ...
            <Card>
              <CardBody>
                <Row>
                  <Col lg={6}>
                    <p>
                      Slider with marks, <code>step=null</code>
                    </p>
                  ...
                  <Col lg={6}>
                    <p>
                      Slider with marks, <code>included=false</code>
                    </p>
                    <div className={classes.markedSliderWrap}>
                  ...
                  <Col lg={6}>
                    <p>
                      Slider with marks and steps, <code>included=false</code>
                    </p>
                    <div className={classes.markedSliderWrap}>
                      <Slider
                        min={-10}
            ...
            <HeaderDemo
              ...
              title="Range"
              className="mt-5"
              subTitle={<React.Fragment>See 8 examples below:</React.Fragment>}
            />
            {/* END Header 2 */}
            {/* START Card Example */}
            <Card>
              <CardBody>
                <Row>
                  <Col lg={6}>
                    <p>
                      Basic Range，<code>allowCross=false</code>
                    </p>
                  ...
                  <Col lg={6}>
                    <p>
                      Basic Range，<code>step=20, dots</code>{' '}
                    </p>
                    <div className={classes.rangeSliderWrap}>
                  ...
                  <Col lg={6}>
                    <p>
                      Range with dynamic <code>max</code> <code>min</code>
                    </p>
                    <div className={classes.rangeSliderWrap}>
                      <DynamicBounds>
            ...
            <HeaderDemo
              ...
              title="Sliders"
              className="mt-5"
              subTitle={<React.Fragment>See 7 examples below:</React.Fragment>}
            />
            {/* END Header 3 */}
            {/* START Card Example */}
            <Card>
              <CardBody>
                <Row>
                  ...
                  <Col lg={6}>
                    <p>
                      Basic Slider，<code>step=20, dots</code>
                    </p>
                    <div className={classes.rangeSliderWrap}>
                  ...
                  <Col lg={6}>
                    <p>
                      Slider with dynamic <code>min</code>, <code>max</code>
                    </p>
                    <div className={classes.rangeSliderWrap}>
                      <DynamicBounds>
              ...
              <CardBody>
                <Row>
                  ...
                  <Col lg={3}>
                    <p>Range with marks and steps</p>
                    <div className={classes.markedSliderVerticalWrap}>
                      <Range vertical min={-10} marks={marks} step={10} defaultValue={[20, 40]} />
                    </div>
                  </Col>
                </Row>
              </CardBody>
