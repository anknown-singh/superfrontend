              ...
              <Form>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <InputGroup>
                      <InputGroupAddon addonType="prepend">$</InputGroupAddon>
                      <InputGroupAddon addonType="prepend">0.00</InputGroupAddon>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <InputGroup>
                      ...
                      <InputGroupAddon addonType="append">$</InputGroupAddon>
                      <InputGroupAddon addonType="append">0.00</InputGroupAddon>
                    </InputGroup>
                  </Col>
                </FormGroup>
                {/* END Input */}
                  ...
                  <Col sm={9}>
                    <InputGroup>
                      ...
                      <UncontrolledButtonDropdown tag={InputGroupAddon} addonType="prepend">
                        ...
                        <DropdownMenu persist>
                          {/* START Dropdown Content */}
                          <DropdownItem header>Select Priveleges:</DropdownItem>
                          <DropdownItem>
                ...
                <FormGroup row>
                  ...
                  <Col sm={9}>
                    <InputGroup>
                      ...
                      <InputGroupAddon addonType="append">Selected</InputGroupAddon>
                    </InputGroup>
                  </Col>
                </FormGroup>
                {/* END Input */}
